                                            ...
                                            <div class="box-content p-relative">
                                                ...
                                                <div class="box-content-body">
                                                    ...
                                                    <h4 class="title-block mb-20">
                                                        <a href="<?= base_url('cours/ficheCours')?>" class="effect-ajax">Let's study <?= $cours[$i]->titre?></a>
                                                    </h4>
                                                    <p>Streamer fish California halibut Pacific saury. Slickhead grunion
                                                        lake trout. Canthigaster rostrata spikefish…</p>
                                                    <a href="<?= base_url('cours/ficheCours')?>?cours=<?=$cours[$i]->id?>" class="effect-ajax link-vist p-relative mt-20">
