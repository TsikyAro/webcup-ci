<main class="main-root">
            ...
            <div class="wrapper">
                                                            ...
                                                            <div class="swiper-slide d-flex align-items-center">
                                                                ...
                                                                <div class="box-text" data-swiper-parallax="30%"
                                                                    ...
                                                                    <h4 class="title-block mb-10">
                                                                        <?php echo $temoinage['name'] ?>
                                                                    </h4>
                                                                    <h5 class="sm-title-block">
                                                                        <?php echo $temoinage['fonction'] ?>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        <?php endforeach ?>
                ...
                <section class="our-blog section-margin p-relative dsn-swiper" data-dsn-animate="section"
                    ...
                    <div class="container mb-70 d-flex text-center flex-column align-items-center">
                        ...
                        <h2 class="section-title  title-cap">
                            Develop your skills and become a model citizen zombie with HumanizeU
                        </h2>
                                        ...
                                        <div class=" blog-item p-relative d-flex align-items-center h-100 w-100"
                                            ...
                                            <div class="box-meta">
                                                <div class="entry-date">
                                                    <span class="author">HumanizeU</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="box-content p-relative">
                                                ...
                                                <div class="box-content-body">
                                                    <div class="metas">
                                                        <span class="mb-5">Let's study <?= $cour->titre ?></span>
                                                    </div>
    ...
    <div class="contact-btn">
        <div class="contact-btn-txt">Remark</div>
    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="form-box">
                            ...
                            <form onsubmit="return validateForm()" class="form" method="post"
                                action="<?php echo base_url('remarque/insert'); ?>" data-toggle="validator">
                            ...
                            <script>
                                ...
                                function isValidEmail(email) {
                                    ...
                                    // Cette expression régulière est un exemple simple, vous pouvez utiliser une plus robuste
