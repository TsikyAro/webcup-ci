                                                ...
                                                <div class="content p-relative">
                                                    ...
                                                    <h1 class="title user-no-selection d-inline-block ">
                                                        <a href="project1.html" class="effect-ajax"
                                                            data-dsn-ajax="slider">Maybe speaker </a>
                                                    </h1>
                                                    <hr class="mt-20" />

                                                    <p class="max-w570 mt-20 description ">Vin tries to reflect Diesel’s
                                                        vision
                                                        and combines</p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="content p-relative">
                                                    ...
                                                    <h1 class="title user-no-selection d-inline-block ">
                                                        <a href="project2.html" class="effect-ajax"
                                                            data-dsn-ajax="slider">Yaren collection</a>
                                                    </h1>
                                                    <hr class="mt-20" />
                                                ...
                                                <div class="content p-relative">
                                                    ...
                                                    <h1 class="title user-no-selection d-inline-block ">
                                                        <a href="project3.html" class="effect-ajax"
                                                            data-dsn-ajax="slider">Huggl Power Pack</a>
                                                    </h1>
                                                    <hr class="mt-20" />
