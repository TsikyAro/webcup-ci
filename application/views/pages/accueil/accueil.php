                                            ...
                                            <div class="content p-relative">
                                                ...
                                                <h1 class="title user-no-selection d-inline-block ">
                                                    <a href="project1.html" class="effect-ajax"
                                                        data-dsn-ajax="slider">Transformation</a>
                                                </h1>
                                                <hr class="mt-20" />

                                                <p class="max-w570 mt-20 description ">The process of change and
                                                    evolution of zombies, from their initial state to a new social
                                                    identity, through learning and adaptation.</p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="content p-relative">
                                                ...
                                                <h1 class="title user-no-selection d-inline-block ">
                                                    <a href="project2.html" class="effect-ajax"
                                                        data-dsn-ajax="slider">Integration</a>
                                                </h1>
                                                <hr class="mt-20" />

                                                <p class="max-w570 mt-20 description ">The process of incorporating
                                                    zombies into human society, adopting its norms, values and behaviors
                                                    for harmonious coexistence.</p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="content p-relative">
                                                ...
                                                <h1 class="title user-no-selection d-inline-block ">
                                                    <a href="project3.html" class="effect-ajax"
                                                        data-dsn-ajax="slider">Learning</a>
                                                </h1>
                                                <hr class="mt-20" />

                                                <p class="max-w570 mt-20 description ">The acquisition of new knowledge,
                                                    skills and behaviors by zombies, enabling them to adapt and
                                                    integrate successfully into human society.</p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="content p-relative">
                                                ...
                                                <h1 class="title user-no-selection d-inline-block ">
                                                    <a href="project4.html" class="effect-ajax"
                                                        data-dsn-ajax="slider">Principal Garden</a>
                                                </h1>
                                                <hr class="mt-20" />
                            ...
                            <div class="d-flex flex-column">
                                <p class="sub-heading line-shap line-shap-after ">
                                    <span class="line-bg-left">
                                        For any questions or assistance, feel free to check out our help section or
                                        contact
                                        us directly. Our team is here to assist you in successfully transitioning to a
                                        life
                                        among humans
                                    </span>
                                </p>
                            ...
                            <div class="button-box d-flex justify-content-end align-items-center">
                                <div>
                                    <a href="contact.html" class="mt-30 effect-ajax dsn-button p-relative">
                                        <span class="dsn-border-rdu "></span>Contact
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="column-right">
                                <h5>2024 © by
                                    <a class="link-hover" data-hover-text="Force" target="_blank" rel="nofollow"
                                        href="https://themeforest.net/user/design_grid/portfolio/">Code</a>
                                </h5>
                            </div>
                        </div>
                    </div>
